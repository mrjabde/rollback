...
helm install demo-app ./helm -n flask-app --set image.tag=v1
# Vérifier navigateur -> "Version 1"

# Upgrade vers le tag v2
helm upgrade demo-app ./helm -n flask-app --set image.tag=v2
# Vérifier navigateur -> "Version 2"

# Voir l'historique des releases
helm history demo-app -n flask-app

# Rollback à la révision 1 (qui utilisait l'image v1)
helm rollback demo-app 1 -n flask-app
